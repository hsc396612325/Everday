package com.example.heshu.everyday.common;
...
import com.example.heshu.everyday.zhihu.ChooseAreaFragment;
import com.example.heshu.everyday.fragment.MovieFragment;
import com.example.heshu.everyday.eyepetizer.EyepetizerFragment;
...
import com.example.heshu.everyday.zhihu.ZhihuFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigation_weather) {  // 天气
            ...
            replaceFragment( new EyepetizerFragment());
            mDrawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED);//打开手势滑动
